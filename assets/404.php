...
<html>
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4" >
    ...
    <input type="hidden" id="anPageName" name="page" value="buscador" />
...
<!--           <img
          ...
          <div class="frame-3553" style="position: relative; padding: 80px 0px;">
            <div style="display: flex; justify-content: center;">
              <img style="width: 25vh;" src="img/undraw-searching-re-3ra9-1@2x.svg">
            </div>
            <div style="display: flex; text-align: center; padding: 20px 0px;">
              <p class="poppins-normal-star-dust-16px">
                Este apartado estará listo proximamente
              </p>
            </div>
          </div>
