...
// exit();
  ...
  $sql3 = "SELECT * FROM detalle_job_skills DJS left join skills S ON DJS.idSkill = S.idSkill  WHERE idJob = ".$_GET["idemp"];
  $db = $dbh->prepare($sql3);
  $db->execute();
    ...
    <div class="container-center-horizontal">
      <div class="empleo-individual screen">
        ...
        <p class="selecciona-y-respond poppins-normal-storm-dust-14px" style="position: relative; top:190px;">
          <a href="detalle_empleo.php?idemp=<?php echo $_GET["idemp"];?>" style="text-decoration: none;" class="poppins-normal-storm-dust-14px">
          <img
            class="arrow"
        ...
        <div class="habilidad-tecnica2 poppins-medium-malachite-16px">Habilidad tecnica:</div>
...
<!--             <img
            ...
            <div class="javasript poppins-normal-storm-dust-16px">
              <?php  echo $regJobsSkills->descrip_skiill; ?>
            </div>
            ...
            <div class="javasript poppins-normal-storm-dust-16px" style="margin-left: 203px; border-radius: 50%; background-color: #606060; color: white; width: 20px; height: 20px; text-align: center; font-size: 12px;">E</div>

            <img id="img_<?php echo $regJobsSkills->idSkill;?>"
              ...
              alt="Chevron-down 1" onclick="verDetalle(<?php echo $regJobsSkills->idSkill;?>)"
            />

          </div>


          <div id="detalle_<?php echo $regJobsSkills->idSkill;?>" style="display: none;">
            
            <div class="nombres-1">
              <select style="width: 95%; border: none;" name="nivel_<?php echo $regJobsSkills->idSkill;?>" id="nivel_<?php echo $regJobsSkills->idSkill;?>" class="seleccionar-nivel poppins-normal-star-dust-16px">
...
<div class="fra_btn_siguiente">
  <div class="btn_siguiente" style="background-color: #339698;">
    <div class="descripcin poppins-semi-bold-white-12px" onclick="procesar_Habilidad()">Siguiente</div>
  </div>
</div>
...
<!--         <div class="frame-3700">
    ...
    <script type="text/javascript">
      ...
      function procesar_Habilidad() {
        ...
        $.ajax({
          url: 'ins_habilidad.php',
          type: 'POST',
          data: {codEmp: $("#codJob").val(), niveles: ddDataNiveles, experiencias: ddDataExperiencia},
        })
        .done(function(data) {
