          ...
          <div class="frame-3553">
              ...
              <div class="main-frame">
                ...
                <div class="row" style="border: none; margin: 0px auto; padding: 0px; width: 100%; ">
                  <div class="col-md-12">
                    <h1 class="titulo">Redes y proyectos</h1>
              ...
              <div class="frame_redes" style="border: none;">
                ...
                <div class="banner_redes" style="padding: 0px 24px;">
                  <div class="row py-3">
                    ...
                    <div class="col-md-12 mt-3 pb-3" style="border-bottom: 1px solid #B8B8B8;" >
                      Redes agregados <br> https://www.inst...
                    </div>
                    <div class="col-md-12 mt-3 pb-3" style="border-bottom: 1px solid #B8B8B8;" >
                        Ver <br>  
                      <svg width="22" height="16" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" clip-rule="evenodd" d="M20 8C20 8 17 15 11 15C5 15 2 8 2 8C2 8 5 1 11 1C17 1 20 8 20 8Z" stroke="#339698" stroke-width="2" stroke-linecap="round"/>
                          <path d="M11 11C12.6569 11 14 9.65685 14 8C14 6.34315 12.6569 5 11 5C9.34315 5 8 6.34315 8 8C8 9.65685 9.34315 11 11 11Z" stroke="#339698" stroke-width="2" stroke-linecap="round"/>
                      </svg>
                    </div>
                    <div class="col-md-12 mt-3 pb-3" style="border-bottom: none;" >
                        Opcion <br>  
